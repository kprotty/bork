...
pub const net = struct {
    ...
    pub const Stream = struct {
        ...
        pub fn getHandle(self: Stream) os.socket_t {
            return self.socket.getHandle();
        }
...
pub const sync = struct {
    pub const Lock = struct {
        ...
        pub fn acquire(self: *Lock) Held {
            ...
            if (@intToPtr(?*Waiter, self.state & WAITING)) |head| {
        ...
        pub const Held = struct {
            ...
            pub fn release(self: Held) void {
                ...
                const waiter = @intToPtr(*Waiter, self.lock.state & WAITING);
                self.lock.state = @ptrToInt(waiter.next);
